...
public class PreviewBarView extends AbstractView {
	...
	public PreviewBarView(TeacherModel model) {
		this.model = model;
		previews = new ArrayList<PreviewBarView.MiniPreview>();
	...
	public void propertyChange(PropertyChangeEvent arg0) {
		...
		if(n.equals(TeacherController.QUESTION)) {
